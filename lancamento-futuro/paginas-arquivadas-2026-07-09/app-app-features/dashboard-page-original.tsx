...
export default async function Dashboard() {
  ...
  const semestreLabel = profile?.semestre ? `${profile.semestre}º período` : 'Ciclo básico';
          ...
          <section className="nf-hero" style={{ marginBottom: '28px' }}>
            <div className="nf-hero-l">
              ...
              <h1 className="nf-hero-title">
                Bem-vindo de volta,<br /><b>{firstName}.</b> Vamos <em>fixar</em><br />mais um pouco hoje?
              </h1>
              <p className="nf-hero-sub">
                {totalHoje > 0
                  ? `Você tem ${totalHoje} flashcard${totalHoje > 1 ? 's' : ''} esperando revisão hoje. Cada card que você revisa agora vira memória de longo prazo — na hora da prova você vai lembrar.`
                  : 'Você está em dia com todas as revisões. Que tal explorar um resumo novo ou treinar com questões?'}
              </p>
              <span className="nf-streak-pill"><span>🔥</span>A NeuroFix cuida do seu plano de estudo</span>
              <div className="nf-hero-stats">
                ...
                <div className="nf-h-stat">
                  <span className="nf-h-stat-lbl">Revisões em atraso</span>
            ...
            <div className="nf-three-col">
              ...
              <div className="nf-panel">
                <div className="nf-panel-head">
                  ...
                  <Link className="nf-panel-link" href="/biblioteca">Ver histórico completo →</Link>
                </div>
                  ...
                  <div className="nf-prog-info">
                    ...
                    <div className="copy">
                      {(flashcardsPendentes ?? 0) > 0
                        ? `Você tem ${flashcardsPendentes} flashcard${flashcardsPendentes! > 1 ? 's' : ''} esperando revisão. Comece pelos mais antigos para não esquecer o conteúdo.`
                        : 'Todas as revisões em dia. Aproveite para explorar um resumo novo ou treinar com questões.'}
                    </div>
                  </div>
                </div>
          ...
          <section className="nf-section">
            <div className="nf-simul">
              <div className="nf-simul-l">
                <span className="nf-simul-eyebrow">Pronto para o teste de verdade?</span>
                <h2 className="nf-simul-title">Treine com <b>questões nível prova</b><br />sempre que quiser.</h2>
                <p className="nf-simul-copy">Banco com todas as disciplinas · gabarito comentado · relatório de fixação por tópico ao final. É o simulado que mostra o que você já domina e o que ainda precisa revisar.</p>
              ...
              <div className="nf-simul-r">
                <div className="nf-sim-stat">
                  ...
                  <div className="info"><div className="v">Banco completo</div><div className="l">Todas as disciplinas do seu ciclo</div></div>
                </div>
                <div className="nf-sim-stat">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                  <div className="info"><div className="v">Gabarito comentado</div><div className="l">Você entende por que a resposta é aquela</div></div>
                </div>
                <div className="nf-sim-stat">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                  <div className="info"><div className="v">Relatório por tópico</div><div className="l">Mostra o que você já domina e o que revisar</div></div>
                </div>
              </div>
            </div>
          </section>
