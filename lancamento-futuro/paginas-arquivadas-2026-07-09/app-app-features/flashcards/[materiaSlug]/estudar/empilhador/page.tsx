...
import EmpilhadorGame from '@/components/flashcards/games/EmpilhadorGame';

export const dynamic = 'force-dynamic';
export const revalidate = 0;

export default async function EmpilhadorPage({ params }: { params: Promise<{ materiaSlug: string }> }) {
