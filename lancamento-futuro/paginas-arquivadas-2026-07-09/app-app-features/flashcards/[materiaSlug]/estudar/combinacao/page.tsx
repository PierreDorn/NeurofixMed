...
import CombinacaoGame from '@/components/flashcards/games/CombinacaoGame';

export const dynamic = 'force-dynamic';
export const revalidate = 0;

export default async function CombinacaoPage({ params }: { params: Promise<{ materiaSlug: string }> }) {
